const enLang = [
    [
        ...
        { code: 'Key_Backspace', name: 'Backspace', shiftName: 'Backspace', class: 'longkey', }, 
    ],
    [
        { code: 'Key_Tab', name: 'Tab', shiftName: 'Tab', class: 'longkey', }, 
        ...
        { code: 'Key_Delete', name: 'Delete', shiftName: 'Delete', class: 'longkey', },
    ],
    [
        { code: 'Key_Caps', name: 'CapsLock', shiftName: 'CapsLock', class: 'longkey', }, 
        ...
        { code: 'Key_Enter', name: 'Enter', shiftName: 'Enter', class: 'longkey', },
    ],
    [
        { code: 'Key_Shift_Left', name: 'Shift', shiftName: 'Shift', class: 'longkey', }, 
        ...
        { code: 'Key_Shift_Right', name: 'Shift', shiftName: 'Shift', class: 'longkey', }, 
    ],
    [
        { code: 'Key_Ctrl_Left', name: 'Ctrl', shiftName: 'Ctrl', class: 'longkey', }, 
        { code: 'Key_Win', name: 'Win', shiftName: 'Win', class: 'longkey', }, 
        { code: 'Key_Alt_Left', name: 'Alt', shiftName: 'Alt', class: 'longkey', }, 
        { code: 'Key_Space', name: ' ', shiftName: ' ', class: 'longkey', }, 
        { code: 'Key_Alt_Right', name: 'Alt', shiftName: 'Alt', class: 'longkey', }, 
        { code: 'Key_Ctrl_Right', name: 'Ctrl', shiftName: 'Ctrl', class: 'longkey', }, 
